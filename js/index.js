        ...
        if (index % 2 === 0) {
          ...
          var endTime =
            index + 1 >= lyrics.length
              ? lyrics[index].words[lyrics[index].words.length - 1].endTime /
                1000
              : lyrics[index + 1].words[lyrics[index + 1].words.length - 1]
                  .endTime / 1000;
...
var closeBtn = lyricsContainer.querySelector(".close-btn");
karaokeBtn.addEventListener("click", function () {
  lyricsContainer.style.translate = "0";
});
closeBtn.addEventListener("click", function () {
  lyricsContainer.style.translate = "0 100%";
});
